...
import com.pnk.bankapi.service.CustomerServiceImpl;
...
class CustomerServiceImplTest {
    ...
    CustomerDTO customer1_modified;
    ...
    void setUp() {
        ...
        customer1_modified = new CustomerDTO();
        customer1_modified.setName("Jane Smith");
        customer1_modified.setAddress("456 Oak St");
        customer1_modified.setDob(LocalDate.of(1988, 2, 24));
    ...
    void testListAllCustomers() {
        ...
        assertThat(customerService.listAllCustomers().get(0).getName()).isEqualTo(customer1.getName());
    }
    ...
    void testListCustomerById() {
        ...
        assertThat(customerService.listCustomerById(1L).get(0).getName()).isEqualTo(customer1.getName());
...
//        when(customerRepository.findByCustomerNameContaining(customer1.getCustomerName())).thenReturn(new ArrayList<>(Collections.singleton(customer1)));         // good
        ...
        assertThat(customerService.listAllCustomersByName(customer1.getName()).get(0).getCustomerId()).isEqualTo(customer1.getCustomerId());
    }
...
//                .thenReturn(new ArrayList<>(Collections.singleton(customer1)));          // good
        ...
        assertThat(customerService.listAllCustomersByEmail(customer1.getEmail()).get(0).getCustomerId()).isEqualTo(customer1.getCustomerId());
    }
...
//                .thenReturn(new ArrayList<>(Collections.singleton(customer1)));             // good
        ...
        assertThat(customerService.listCustomerByNameAndEmail("testName1", "testemail1@email.com").get(0).getCustomerId()).isEqualTo(customer1.getCustomerId());
    }
